    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-5 text-gray-500 md:3/4'>{productData.description}</p>
          <div>
            <p>Select</p>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-2 border px-6 py-6 text-gray-600'>
          <p>An e-commerce website is a online </p>
          <p>E-commercewebsite</p>
        </div>
      </div>
