...
const Add = ({token}) => {
  ...
  const onSubmitHandle = async (e) => {
    e.preventDefault();
    //Điều này ngăn chặn hành vi gửi biểu mẫu mặc định, đảm bảo trang không tải lại khi biểu mẫu được gửi.
    try {
      const formData = new FormData();
      //FormDatađối tượng mới được tạo ra, cho phép bạn thêm các cặp khóa-giá trị biểu diễn các trường biểu mẫu và dữ liệu của chúng
      formData.append('name', name)
      //Trạng namethái được thêm vào formDatađối tượng bằng khóa 'name'.
      ...
      //Mảng sizesđược chuyển đổi thành chuỗi JSON và được thêm khóa 'sizes'.
      //  Điều này là cần thiết vì FormDatayêu cầu chuỗi cho dữ liệu không phải tệp.

      image1 && formData.append('image1', image1)
      //Nếu image1là đúng (tức là một hình ảnh được chọn), nó sẽ được thêm image1vào formDatabằng khóa 'image1'.
